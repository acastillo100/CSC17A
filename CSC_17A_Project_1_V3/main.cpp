 ...
 * Author: Alex
 *
 * Created on November 3, 2017, 10:00 AM
 */
...
AdditionOne PlusOne(Player*,string);        //First addition challenge
AdditionTwo PlusTwo(Player*,string);        //Second addition challenge
SubtractionOne MinusOne(Player*,string);    //First subtraction challenge
SubtractionTwo MinusTwo(Player*,string);    //Second subtraction challenge
MultiplicationOne TimesOne(Player*,string); //First multiplication challenge
MultiplicationTwo TimesTwo(Player*,string); //Second multiplication challenge
DivisionOne DivideOne(Player*,string);      //First division challenge
DivisionTwo DivideTwo(Player*,string);      //Second division challenge
ModulusOne ModOne(Player*,string);          //First modulus challenge
ModulusTwo ModTwo(Player*,string);          //Second modulus challenge
...
int main(int argc, char** argv) 
{
    ...
    {        
        ...
        {
          case 1:    PlusOne(user,player);break;
          case 2:    PlusTwo(user,player);break;
          case 3:    MinusOne(user,player);break;
          case 4:    MinusTwo(user,player);break;
          case 5:    TimesOne(user,player);break;
          case 6:    TimesTwo(user,player);break;
          case 7:    DRules();
                     DivideOne(user,player);
                     break;
          case 8:    DRules();
                     DivideTwo(user,player);
                     break;
          case 9:   ModRules();
                    ModOne(user,player);
                    break;
...
AdditionOne PlusOne (Player *user, string player)
{
...
AdditionTwo PlusTwo (Player *user, string player)
{
...
SubtractionOne MinusOne (Player *user, string player)
{
...
SubtractionTwo MinusTwo (Player *user, string player)
{
...
MultiplicationOne TimesOne (Player *user, string player)
{
...
MultiplicationTwo TimesTwo (Player *user, string player)
{
...
DivisionOne DivideOne(Player *user, string player)
{
...
DivisionTwo DivideTwo(Player *user, string player)
{
...
ModulusOne ModOne(Player *user, string player)
{
...
ModulusTwo ModTwo(Player *user,string player)
{
